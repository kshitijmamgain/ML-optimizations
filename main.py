...
def _get_args():
    ...
    parser.add_argument("--log_path",
                        default="log/"+'{:%Y%m%d-%H:%M:%S}'.format(datetime.datetime.now())+"-project.log", help="path to log path.",
                        type=str)
...
def main():
    ...
    for predictions, actual, mode in [(train_predictions, y_train, 'train'), (test_predictions, y_test, 'test')]:
        ...
        results = me.get_metrics(roc_filename, pr_filename, fpr_fnr_filename, algorithm)
