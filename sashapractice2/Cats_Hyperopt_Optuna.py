...
from sklearn.metrics import auc, accuracy_score, roc_auc_score, roc_curve, confusion_matrix, precision_recall_curve,classification_report
...
#Data
df = pd.read_csv('/content/gdrive/My Drive/sample.csv', header = None)
X = df.iloc[:, 2:]
y = df.iloc[:, 1]
...
#I have got very constrcutive advice from both Kshitij and Ahmed.
#I have to apply pep8, explain and comment my functions better, and add randomsearch to the class
